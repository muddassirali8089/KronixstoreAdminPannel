...
export const order_id = (index) => `e2d7b${index}`;

export const _times = (index) =>
  // 'MM/DD/YYYY'
  [
    '11/08/2023',
    '04/09/2024',
...
export const _postTitles = (index) =>
  [
...
export const _description = (index) =>
  [
